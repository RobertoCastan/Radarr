...
namespace NzbDrone.Core.Indexers.AMule
{
    public class AMuleIndexer : IndexerBase<AMuleIndexerSettings>
    {
        ...
        public AMuleIndexer(IAMuleProxy proxy, IIndexerStatusService indexerStatusService, IConfigService configService, IParsingService parsingService, Logger logger)
