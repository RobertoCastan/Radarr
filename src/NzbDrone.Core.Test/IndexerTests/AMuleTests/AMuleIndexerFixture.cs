        ...
        public async Task should_dedupe_both_network_results_by_hash()
        {
            ...
            Mocker.GetMock<IAMuleProxy>()
                ...
                .Returns(new List<AMuleSearchResult>
                {
                    ...
                    {
                        FileName = "Droned.2026.mkv",
                        Size = 12345,
                        Hash = "0123456789ABCDEF0123456789ABCDEF",
                        Ed2kLink = "ed2k://|file|Droned.2026.mkv|12345|0123456789ABCDEF0123456789ABCDEF|/"
                    }
                });
            Mocker.GetMock<IAMuleProxy>()
                ...
                .Returns(new List<AMuleSearchResult>
                {
                    new AMuleSearchResult
                    {
                        FileName = "Droned.2026.Copy.mkv",
                        Size = 12345,
                        Hash = "0123456789ABCDEF0123456789ABCDEF",
                        Ed2kLink = "ed2k://|file|Droned.2026.Copy.mkv|12345|0123456789ABCDEF0123456789ABCDEF|/"
                    }
                });
