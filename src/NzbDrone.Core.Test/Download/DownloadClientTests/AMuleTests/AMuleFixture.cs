...
namespace NzbDrone.Core.Test.Download.DownloadClientTests.AMuleTests
{
    public class AMuleFixture : DownloadClientFixtureBase<AMule>
    {
        ...
        public async System.Threading.Tasks.Task should_add_ed2k_link_and_return_hash()
        {
            ...
            remoteMovie.Release.DownloadUrl = Ed2kUrl;

            var downloadId = await Subject.Download(remoteMovie, CreateIndexer());
        ...
        public void should_mark_complete_queue_item()
        {
            ...
            item.OutputPath.FullPath.Should().Be("/downloads/radarr/Droned.S01E01.mkv");
        }
        ...
        public void should_report_category_path_as_output_root()
        {
            ...
            status.OutputRootFolders.Single().FullPath.Should().Be("/downloads/radarr");
        }
        ...
        public void should_warn_when_category_is_empty()
        {
            ...
            result.Warnings.Single().PropertyName.Should().Be(nameof(AMuleSettings.MovieCategory));
        }
        ...
        public void should_fail_test_when_category_cannot_be_created_without_incoming_directory()
        {
            ...
            failure.PropertyName.Should().Be(nameof(AMuleSettings.MovieCategory));
        ...
        protected override RemoteMovie CreateRemoteMovie()
        {
            ...
            remoteMovie.Release = new Ed2kReleaseInfo
            {
                Title = _title,
                DownloadUrl = Ed2kUrl,
